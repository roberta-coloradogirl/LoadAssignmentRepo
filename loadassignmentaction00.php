...
// compute paid miles
if( isset($_POST["emptyPaid"]) ) $emptyPaid = $_POST["emptyPaid"];
else $emptyPaid = "";
if( isset($_POST["loadedPaid"]) ) $loadedPaid = $_POST["loadedPaid"];
else $loadedPaid = "";
if( isset($_POST["totalPaid"]) ) $totalPaid = $_POST["totalPaid"];
else $totalPaid = "";
// compute empty miles
if( isset($_POST["endingEmpty"]) ) $endingEmpty = $_POST["endingEmpty"];
else $endingEmpty = "";
if( isset($_POST["beginingEmpty"]) ) $beginingEmpty = $_POST["beginingEmpty"];
else $beginingEmpty = "";
if( isset($_POST["totalEmptyMiles"]) ) $totalEmptyMiles = $_POST["totalEmptyMiles"];
else $totalEmptyMiles = "";
// loaded miles
if( isset($_POST["endingLoaded"]) ) $endingLoaded = $_POST["endingLoaded"];
else $endingLoaded = "";
if( isset($_POST["beginingLoaded"]) )$beginingLoaded = $_POST["beginingLoaded"];
else $beginingLoaded = "";
if( isset($_POST["totalLoadedMiles"]) ) $totalLoadedMiles = $_POST["totalLoadedMiles"];
else $totalLoadedMiles ="";
// actual miles
if( isset($_POST["emptyActual"]) ) $emptyActual = $_POST["emptyActual"];
else $endingEmpty = "";
// compute loaded miles
if( isset($_POST["loadedActual"]) ) $loadedActual = $_POST["loadedActual"];
else $loadedActual = "";
// variance
if( isset($_POST["emptyVariance"]) ) $emptyVariance = $_POST["emptyVariance"];
else $emptyVariance = "";
if( isset($_POST["loadedVariance"]) ) $loadedVariance = $_POST["loadedVariance"];
else $loadedVariance = "";
// Total Miles
if( isset($_POST["totalActual"]) ) $totalActual = $_POST["totalActual"];
else $totalActual = "";
if( isset($_POST["totalMiles"]) ) $totalMiles =$_POST["totalMiles"];
else $totalMiles = "";
if( isset($_POST["totalVariance"]) ) $totalVariance = $_POST["totalVariance"];
else $totalVariance = "";
...
$fileName = "";
if ( $loadNumber != "NOT Set" ) $fileName = 'testLoad_'.$loadNumber.'.txt';
...
if ( file_exists($fileName) ) {
  ...
  if ( $fH ) {
    ...
    if ( $dbRec[0] == $loadNumber ) {
      ...
      if( $brokerLoadID != "" ) $dbRec[5] = $brokerLoadID;
      else $brokerLoadID = $dbRec[5];
    ...
    if ( $newLoad == "new" ) {
      $newLoad = "update";
      $actionButton = "Find";
      $dbRec = array($loadNumber,$newLoad,$loadStartDate,$actionButton,$brokerName,$brokerLoadID,$brokerPhone,$loadTemp,
...
function calculateOdoMiles() {
  ...
  <body>
    <form id="loadForm" action="./loadassignmentaction00.php/" method="post">
      <table border="0" align="center" width="80%">
        ...
        <tr>
          ...
          <td align="center" colspan="4">
            <div class="menubar">
              <ul>
                <li><a href="./pagedloadassignment01.html/" tabindex="18">Shipper</a></li>
                <li><a href="./pagedloadassignment02.html/" tabindex="19">Consignee</a></li>
                <li><a href="./pagedloadassignment03.html/" tabindex="20">Pick(s)</a></li>
                <li><a href="./pagedloadassignment04.html/" tabindex="21">Drop(s)</a></li>
                <li><a href="./pagedloadassignment05.html/" tabindex="22">Fuel</a></li>
              </ul>
            </div>
          </td>
          <td colspan="1">&nbsp;</td>
          ...
          <td align="left" colspan="3">
            <table border="0" align="center" cellpadding="1" cellspacing="0">
              <tr>
                ...
                <td align="left">
                  <input type="text" size="20" name="loadNumber" value=<?php echo $loadNumber; ?> tabindex="1" onblur="validateLoadNumber(this)" />
                </td>
                <td align="center">
                  <input id="varNwLd" type="hidden" name="newLoad" value="<?php echo $newLoad;?>" />
                  <input id="ldStrtDt" type="hidden" name="loadStartDate" value="<?php echo $loadStartDate?>"/>
              ...
              <td align="left" colspan="3">
                <table border="0" align="center" cellpadding="5">
                  <tr>
                    <td>Broker Name:</td>
                    <td>
                      <input type="text" size="20" name="brokerName" value="<?php echo $brokerName;?>" tabindex="4" />
                    </td>
